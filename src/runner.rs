...
pub const LOG_TARGET: &str = "wasmi-0.13.2";
...
impl Interpreter {
    ...
    pub fn start_execution<'a, E: Externals + 'a>(
        ...
        log::info!(target: LOG_TARGET, "Interpreter start execution");
        ...
        log::info!(target: LOG_TARGET, "Interpreter start LOOP");
        self.run_interpreter_loop(externals)?;
        log::info!(target: LOG_TARGET, "Interpreter end LOOP");

        let opt_return_value = self
            .return_type
            .map(|vt| self.value_stack.pop().with_type(vt));

        log::info!(target: LOG_TARGET, "Interpreter returned opt_return_value={:?}", opt_return_value);
        ...
        log::info!(target: LOG_TARGET, "Interpreter end execution");
        Ok(opt_return_value)
    }
    ...
    fn run_interpreter_loop<'a, E: Externals + 'a>(
        ...
        loop {
            ...
            log::info!(target: LOG_TARGET, "LOOP step 2");
            ...
            if !function_context.is_initialized() {
                log::info!(target: LOG_TARGET, "LOOP step 3.1");
            ...
            match function_return {
                ...
                RunResult::NestedCall(nested_func) => {
                    ...
                    log::info!(target: LOG_TARGET, "LOOP step B.2");
                    ...
                    match *nested_func.as_internal() {
                        ...
                        FuncInstanceInternal::Host { ref signature, .. } => {
                            ...
                            log::info!(target: LOG_TARGET, "LOOP step B.3");
